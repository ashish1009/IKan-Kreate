...
namespace IKan
{
  ...
  : m_window(windowPtr)
  {
    ...
    IK_LOG_INFO(LogModule::GraphicsContext, "Creating Open GL Renderer Context ");
  ...
  {
    IK_PROFILE();
    IK_LOG_INFO(LogModule::GraphicsContext, "Destroying Open GL Renderer Context ");
  }
